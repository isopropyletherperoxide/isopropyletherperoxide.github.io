...
if (urlParams.has('hikari-mode')) {
    console.log("hikari mode ON");
    document.getElementsByTagName("h1")[0].setHTML("Exploring Interfaces Glasgowly, Special 1/1 hikari_no_yume Limited Edition");
    document.getElementsByClassName("blog_box")[0].insertAdjacentHTML("afterbegin", "<p>This is a special <strong>Gold Edition</strong> of Exploring Interfaces Glasgowly provided to @hikari_no_yume exclusively</p>")
}
</script> 
